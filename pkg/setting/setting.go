...
import (
	...
	"gitote.com/gitote/go-libravatar"

	"gitote.com/gitote/gitote/pkg/bindata"
	"gitote.com/gitote/gitote/pkg/process"
	"gitote.com/gitote/gitote/pkg/user"
)
...
func getOpenSSHVersion() string {
	...
	// Trim unused information: https://gitote.com/gitote/gitote/issues/4507#issuecomment-305150441
...
func NewContext() {
	...
	CustomPath = os.Getenv("GITOTE_CUSTOM")
	if len(CustomPath) == 0 {
	...
	// Windows server and OpenSSH version lower than 5.1 (https://gitote.com/gitote/gitote/issues/4507)
...
2. OpenSSH version is lower than 5.1`)
	...
	RepoRootPath = sec.Key("ROOT").MustString(path.Join(homeDir, "gitote-repositories"))
...
func newSessionService() {
	...
	SessionConfig.CookieName = Cfg.Section("session").Key("COOKIE_NAME").MustString("i_like_gitote")
