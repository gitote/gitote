...
func Webhooks(c *context.Context) {
	...
	c.Data["Description"] = c.Tr("repo.settings.hooks_desc", "https://gitlab.com/gitote/gitote-client/wiki/Repositories-Webhooks")
