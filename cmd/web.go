...
import (
	...
	"gitote.com/gitote/gitote/pkg/template"
	"gitote.com/gitote/gitote/routes"
	"gitote.com/gitote/gitote/routes/admin"
	apiv1 "gitote.com/gitote/gitote/routes/api/v1"
	"gitote.com/gitote/gitote/routes/dev"
	"gitote.com/gitote/gitote/routes/org"
	"gitote.com/gitote/gitote/routes/repo"
	"gitote.com/gitote/gitote/routes/user"
)
...
func checkVersion() {
	...
	if tplVer != setting.AppVer {
		if version.Compare(tplVer, setting.AppVer, ">") {
			log.Fatal(2, "Binary version is lower than template file version, did you forget to recompile Gitote?")
		} else {
